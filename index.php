...
$query = "SELECT * FROM tb_produk WHERE ID_Buku like '%".$kata_cari."%' OR
Nama_Produk like '%".$kata_cari."%' ORDER BY ID_Buku ASC";
} else {
//jika tidak ada pencarian, default yang dijalankan query ini
$query = "SELECT * FROM tb_produk ORDER BY ID_Buku ASC";
}
